...
export interface IMobileCatalogueVariantEntity extends IEntityBase, Document {
...
export const MobileCatalogueVariantEntitySchema =
  new Schema<IMobileCatalogueVariantEntity>({
...
const MobileCatalogueVariant = model<IMobileCatalogueVariantEntity>(
  EntityConstants.MOBILE_CATALOGUE_VARIANT_MODEL_NAME, // Model name
  MobileCatalogueVariantEntitySchema, // Schema
  EntityConstants.MOBILE_CATALOGUE_VARIANT_COLLECTION_NAME //collection name
);

export default MobileCatalogueVariant;
