...
export interface IWebCatalogueEntity extends IEntityBase, Document {
...
export const WebCatelogueEntitySchema = new Schema<IWebCatalogueEntity>({
  ...
  variants: [
    {
      type: Types.ObjectId,
      ref: EntityConstants.WEB_CATALOGUE_VARIANT_MODEL_NAME,
    },
  ],
...
const WebCatalogue = model<IWebCatalogueEntity>(
  EntityConstants.WEB_CATALOGUE_MODEL_NAME, // Model name
  WebCatelogueEntitySchema, // Schema
  EntityConstants.WEB_CATALOGUE_COLLECTION_NAME //collection name
);

export default WebCatalogue;
