...
export interface IIosCatalogueVariantEntity extends IEntityBase, Document {
...
export const IosCatalogueVariantEntitySchema = new Schema<IIosCatalogueVariantEntity>({
...
const IosCatalogueVariant = model<IIosCatalogueVariantEntity>(
  EntityConstants.IOS_CATALOGUE_VARIANT_MODEL_NAME, // Model name
  IosCatalogueVariantEntitySchema, // Schema
  EntityConstants.IOS_CATALOGUE_VARIANT_COLLECTION_NAME //collection name
);

export default IosCatalogueVariant;
