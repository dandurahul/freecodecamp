...
export interface IAndroidCatalogueVariantEntity extends IEntityBase, Document {
...
export const AndroidCatalogueVariantEntitySchema =
  new Schema<IAndroidCatalogueVariantEntity>({
...
const AndroidCatalogueVariant = model<IAndroidCatalogueVariantEntity>(
  EntityConstants.ANDROID_CATALOGUE_VARIANT_MODEL_NAME, // Model name
  AndroidCatalogueVariantEntitySchema, // Schema
  EntityConstants.ANDROID_CATALOGUE_VARIANT_COLLECTION_NAME //collection name
);

export default AndroidCatalogueVariant;
