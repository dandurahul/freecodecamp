...
export interface IPosCatalogueVariantEntity extends IEntityBase, Document {
...
export const PosCatalogueVariantEntitySchema = new Schema<IPosCatalogueVariantEntity>({
...
const PosCatalogueVariant = model<IPosCatalogueVariantEntity>(
  EntityConstants.POS_CATALOGUE_VARIANT_MODEL_NAME, // Model name
  PosCatalogueVariantEntitySchema, // Schema
  EntityConstants.POS_CATALOGUE_VARIANT_COLLECTION_NAME //collection name
);

export default PosCatalogueVariant;
