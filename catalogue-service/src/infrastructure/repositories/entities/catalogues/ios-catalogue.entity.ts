...
export interface IIosCatalogueEntity extends IEntityBase, Document {
...
export const IosCatelogueEntitySchema = new Schema<IIosCatalogueEntity>({
  ...
  variants: [
    {
      type: Types.ObjectId,
      ref: EntityConstants.IOS_CATALOGUE_VARIANT_MODEL_NAME,
    },
  ],
...
const IosCatalogue = model<IIosCatalogueEntity>(
  EntityConstants.IOS_CATALOGUE_MODEL_NAME, // Model name
  IosCatelogueEntitySchema, // Schema
  EntityConstants.IOS_CATALOGUE_COLLECTION_NAME //collection name
);

export default IosCatalogue;
