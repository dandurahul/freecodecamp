...
export interface IPosCatalogueEntity extends IEntityBase, Document {
...
export const PosCatelogueEntitySchema = new Schema<IPosCatalogueEntity>({
  ...
  variants: [
    {
      type: Types.ObjectId,
      ref: EntityConstants.POS_CATALOGUE_PURCHASE_VARIANT_MODEL_NAME,
    },
  ],
...
// rohit fixed here
const PosCatalogue = model<IPosCatalogueEntity>(
  EntityConstants.POS_CATALOGUE_MODEL_NAME, // Model name
  PosCatelogueEntitySchema, // Schema
  EntityConstants.POS_CATALOGUE_COLLECTION_NAME //collection name
);
