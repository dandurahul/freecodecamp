...
@injectable()
class AndroidCatalogueFilterService implements IStoreCatalogueFilterService {
  @inject(ContainerTypes.MobileCatalogueRepository)
  private androidCatelogueRepository!: IAndroidCatalogueRepository;
  ...
  async getProductCountBasedOnStores(
    ...
    return plainToInstance(
      ...
      await this.androidCatelogueRepository.getProductCountBasedOnStores(
        filterCriteria
      ),
...
export default AndroidCatalogueFilterService;
